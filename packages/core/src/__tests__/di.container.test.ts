...
describe("DI Container", () => {
	...
	describe("Basic Container Operations", () => {
		it("should register and resolve a simple class", () => {
			...
			const instance = container.resolve(SimpleService) as SimpleService
		...
		it("should resolve dependencies automatically", () => {
			...
			const instance = container.resolve(DependentService) as DependentService
		...
		it("should handle factory registration", () => {
			...
			const instance = container.resolve(TokenBasedService) as TokenBasedService
		...
		it("should override existing registrations", () => {
			...
			const newInstance = container.resolve(SimpleService) as SimpleService
	...
	describe("Hierarchical Container", () => {
		...
		it("should allow child to override parent registrations", () => {
			...
			const parentInstance = container.resolve(SimpleService) as SimpleService
			const childInstance = child.resolve(SimpleService) as SimpleService
	...
	describe("Error Handling", () => {
		it("should throw error for unregistered token", () => {
			expect(() => container.resolve("UNREGISTERED")).toThrow("No provider found for token: UNREGISTERED")
		})
	...
	describe("Property Injection", () => {
		it("should support property injection", () => {
			...
			const instance = container.resolve(PropertyInjectionService) as any
	...
	describe("Legacy Compatibility", () => {
		it("should maintain backward compatibility with legacy inject system", async () => {
			...
			const { resolve, override, resetContainer, Injectable: LegacyInjectable } = await import("../inject")
